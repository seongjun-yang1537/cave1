...
namespace Ingame
{
    public class QuestBoardPopupUIController : UIControllerBaseBehaviour<QuestBoardPopupUIView>, IPopupUIController
    {
        ...
        private List<QuestModel> visibleQuestModels =>
            ...
            .Where(q => q.phase == QuestPhase.Available || q.phase == QuestPhase.InProgress)
            .ToList();
        ...
        private void OnUpdateQuest()
            => view.onQuestList.Invoke(visibleQuestModels);
    }
}
