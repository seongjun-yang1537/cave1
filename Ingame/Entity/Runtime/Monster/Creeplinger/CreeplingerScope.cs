...
namespace Ingame
{
    public class CreeplingerScope : MonsterScope
    {
        protected override void Configure(IContainerBuilder builder)
        {
            ...
            builder.RegisterComponent(GetComponent<CreeplingerController>());
        }
        ...
        {
            builder.Register<IAgentAttackable, RangedAgentAttackable>(Lifetime.Scoped);
        }
