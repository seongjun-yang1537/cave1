...
{
    [CustomEditor(typeof(ChunkedScalarFieldConfig))]
    public class EditorChunkedScalarFieldConfig : Editor
    {
        ...
        {
            var config = (ChunkedScalarFieldConfig)target;
        ...
        private SUIElement CreateFieldControlContent(ChunkedScalarFieldConfig config)
        {
        ...
        private SUIElement CreateGeneratorToolsContent(ChunkedScalarFieldConfig config)
        {
